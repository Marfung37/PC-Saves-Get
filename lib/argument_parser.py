...
filter_parser.add_argument("-sp", "--saves-path", help="path to json file with preset wanted saves (default: GITROOT/saves.json)", metavar="<directory>", default=DEFAULT_SAVES_JSON, type=str)
filter_parser.add_argument("-fp", "--filtered-path", help="output file directory (default: output/last_output.txt)", metavar="<directory>", default=DEFAULT_FILTERED_PATH_FILE, type=str)
